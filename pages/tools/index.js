...
Page({
  ...
  alicopy: function(e) {
    wx.setClipboardData ? wx.setClipboardData({
        data: "http://jh.dp77777.net/",
        success: function(e) {
            wx.showToast({
                title: "复制成功，请前往浏览器粘贴搜一搜",
                icon: "none",
                duration: 4e3
            });
        }
  ...
  goct1:function(){
    wx.navigateTo({
      url: '../../pagesD/pages/base/index'
    })
  },
  goct2:function(){
    wx.navigateTo({
      url: '../../pagesD/pages/wholeGrade/wholeGrade'
    })
  },
  goct3:function(){
    wx.navigateTo({
      url: '../../pagesD/pages/typePractice/typePractice'
    })
  },
  go8:function(){
    wx.navigateTo({
  ...
  goqinghui:function(){
    wx.navigateTo({
      url: '../../pagesC/pages/qh/index'
    })
  },
  gozhendong:function(){
    wx.navigateTo({
      url: '../../pagesC/pages/zhendong/index'
    })
  },

  gozhinanzhen:function(){
    wx.navigateTo({
      url: '../../pagesA/pages/lp/lp'
    })
  },
  goshanguangdeng:function(){
    wx.navigateTo({
      url: '../../pagesC/pages/bainian/bainian'
    })
  },
